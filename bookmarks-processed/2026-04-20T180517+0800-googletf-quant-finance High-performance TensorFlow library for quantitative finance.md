---
title: "google/tf-quant-finance: High-performance TensorFlow library for quantitative finance."
url: "https://github.com/google/tf-quant-finance"
description: "High-performance TensorFlow library for quantitative finance. - google/tf-quant-finance"
collection: "finance"
subcollection:
tags:
featured:
added: "2026-04-20T18:05:17+08:00"
---
## TF Quant Finance: TensorFlow based Quant Finance Library (ARCHIVED)

> [!important] Important
> This library is no longer maintained and has been archived. If you depend on the functionality provided by this library, we suggest to fork it and continue development elsewhere.
...
First, please install the most recent version of TensorFlow by following the [TensorFlow installation instructions](https://tensorflow.org/install). For example, you could install TensorFlow
...
- Ito Processes: Framework for defining [Ito processes](https://en.wikipedia.org/wiki/It%C3%B4_calculus#It%C3%B4_processes). Includes methods for sampling paths from a process and for solving the associated backward Kolmogorov equation.
...
See [`tf_quant_finance/examples/`](https://github.com/google/tf-quant-finance/tree/master/tf_quant_finance/examples) for end-to-end examples. It includes tutorial notebooks such as:
...
We're eager to collaborate with you! See [CONTRIBUTING.md](https://github.com/google/tf-quant-finance/blob/master/CONTRIBUTING.md) for a guide on how to contribute. This project adheres to TensorFlow's code of conduct. By participating, you are expected to uphold this code.

## Development

This section is for developers who want to contribute code to the library. If you are only interested in using the library, please follow the instructions in the [Installation](#installation) section.
...
This library requires the [Bazel](https://bazel.build/) build system. Please follow the [Bazel installation instructions](https://docs.bazel.build/versions/master/install.html) for your platform.
...
will run tests in [sobol\_test.py](https://github.com/google/tf-quant-finance/blob/master/tf_quant_finance/math/random_ops/sobol/sobol_test.py).
...
3. [tf-quant-finance@googlegroups.com](mailto:tf-quant-finance@googlegroups.com): Open mailing list for discussion and questions of this library.
...
This library is licensed under the Apache 2 license (see [LICENSE](https://github.com/google/tf-quant-finance/blob/master/LICENSE)). This library uses Sobol primitive polynomials and initial direction numbers which are licensed under the BSD license.